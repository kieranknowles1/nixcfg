      ...
      fonts.fontconfig = {
        ...
        defaultFonts = {
          monospace = lib.singleton (
            ...
            if cfg.fonts.defaultMono == pkgs.nerd-fonts.dejavu-sans-mono then
              "DejaVuSansMono"
            else
              builtins.throw "Unknown default monospace font"
          );
        };
      };

      home.packages = lib.optional isDesktop config.custom.fonts.defaultMono;
    };
}
