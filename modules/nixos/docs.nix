    ...
    custom.docs-generate.file =
      ...
      in
      {
        ...
        "host-options.schema.json" =
          mkSchema "NixOS" self.nixosModules.default
            cfg.jsonIgnoredOptions.nixos;
        "user-options.md" = {
        ...
        "user-options.schema.json" =
          mkSchema "Home Manager" self.homeManagerModules.default
            cfg.jsonIgnoredOptions.home;
        ...
        "flake-tree.svg" = {
          ...
          source =
            pkgs.runCommand "flake-tree.svg"
              {
